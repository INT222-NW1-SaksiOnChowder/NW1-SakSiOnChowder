...
<template>
    <div class="w-full min-h-screen max-h-full bg-Background">
      <div class="bg-LightBlue text-BlueFonts drop-shadow-lg">
        <h1
          class="h-24 flex justify-center items-center drop-shadow-lg text-4xl font-bold"
        >
      ...
      <div class="mx-5 mt-2 relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm h-full text-left">
          ...
          <tbody v-if="!isAnnouncementFound" class="bg-Cream">
            ...
            >
              ...
              <td
                class="ann-display px-6 py-4 text-center justify-items-center"
              >
        ...
        <div
          v-if="isAnnouncementFound"
          class="text-center text-3xl my-10 text-BlueFonts"
        >
          No Announcement
        </div>
      </div>
