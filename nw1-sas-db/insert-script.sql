...
values ('บริษัท เน็ตเซอร์พลัส จํากัด รับสมัครงาน 2 ตําแหน่ง','บริษัท เน็ตเซอร์พลัส จํากัด เปิดรับสมังาน 2 ตําแหน่ง Application Support และ Customer Support','N',1);
...
values ('แนวปฎิบัติการสอบออนไลน์ พ.ศ. 2565','ประกาศมหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี เรื่องแนวทางปฎิบัติการสอบออนไลน์ พ.ศ. 2565', '2023-01-26 23:00:00','Y',3);

insert into Announcements(announcementTitle,announcementDescription,publishDate,closeDate,announcementDisplay,categoryId) 
values ('กิจกรรมพี่อ้อย พี่ฉอด On Tour 2566','ขอเชิญนักศึกษาทุกชั้นปี เข้าร่วมกิจกรรมพี่อ้อย พี่ฉอด On Tour','2023-04-18 23:00:00','2023-05-08 11:00:00','Y',3);
