...
truncate Users;
insert into Users(username,name,password,email,role,createdOn,updatedOn) values("sanit","Sanit Sirisawatvatana","$argon2i$v=19$m=16,t=2,p=1$eEtZelVUb1hIMjdkS3NMTQ$oef0vWIOkD9oPgdZ0SBHQA","sanit.sir@kmutt.ac.th","admin","2023-08-15 08:00:00+07:00","2023-08-15 08:00:00+07:00");
insert into Users(username,name,password,email,role,createdOn,updatedOn) values("pornthip","Pornthip Sirijutikul","$argon2i$v=19$m=16,t=2,p=1$eEtZelVUb1hIMjdkS3NMTQ$gMuJtShyyDdXpgTt1ExIYw","pornthip.sri@kmutt.ac.th","announcer","2023-08-15 09:30:00+07:00","2023-08-15 09:30:00+07:00");
insert into Users(username,name,password,email,role,createdOn,updatedOn) values("jaruwan_w","Jaruwan Maneesart","$argon2i$v=19$m=16,t=2,p=1$eEtZelVUb1hIMjdkS3NMTQ$3dj9+I+b+9U+OPfdOEjEhg","jaruwan.wee@kmutt.ac.th","announcer","2023-08-16 08:00:00+07:00","2023-08-16 08:00:00+07:00");
insert into Users(username,name,password,email,role,createdOn,updatedOn) values("vichchuda","Vichchuda Tedoloh","$argon2i$v=19$m=16,t=2,p=1$eEtZelVUb1hIMjdkS3NMTQ$oJQtns92qDSJ0PM8N40XrQ","vichchuda.ted@kmutt.ac.th","announcer","2023-08-16 09:30:00+07:00","2023-08-16 09:30:00+07:00");
