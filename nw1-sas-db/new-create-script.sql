...
CREATE TABLE IF NOT EXISTS `SAS`.`Users` (
  ...
  `createdOn` DATETIME NOT NULL DEFAULT LOCALTIME,
  `updatedOn` DATETIME NOT NULL DEFAULT LOCALTIME ON UPDATE LOCALTIME,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `SAS`.`Users_has_Announcements`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SAS`.`Users_has_Announcements` ;

CREATE TABLE IF NOT EXISTS `SAS`.`Users_has_Announcements` (
  `userId` INT NOT NULL,
  `announcementId` INT NOT NULL,
  PRIMARY KEY (`announcementId`, `userId`),
  INDEX `fk_Users_has_Announcements_Announcements1_idx` (`announcementId` ASC) VISIBLE,
  INDEX `fk_Users_has_Announcements_Users1_idx` (`userId` ASC) VISIBLE,
  CONSTRAINT `fk_Users_has_Announcements_Users1`
    FOREIGN KEY (`userId`)
    REFERENCES `SAS`.`Users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Users_has_Announcements_Announcements1`
    FOREIGN KEY (`announcementId`)
    REFERENCES `SAS`.`Announcements` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
