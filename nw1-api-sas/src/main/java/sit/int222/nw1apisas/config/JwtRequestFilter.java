...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (!(request.getRequestURI().equals("/api/token") || request.getRequestURI().contains("/api/subscription") || request.getRequestURI().contains("/api/categories")
                || request.getMethod().equals("GET") && (request.getRequestURI().contains("/api/files/")) || (request.getMethod().equals("GET") && request.getRequestURI().contains("/api/announcements")))) {
